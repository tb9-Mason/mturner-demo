...
export type AlbumsQuery = { __typename?: 'Query', albums: Array<{ __typename?: 'Album', name: string, releaseDate: any, uuid: string, staticRating: number, userRating: number, link: string, artist: { __typename?: 'Artist', name: string } }> };
